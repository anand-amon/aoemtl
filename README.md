...
This implementation corresponds to the model described in the author’s paper, *“AoE-MTL: Gate-Free Expert Selection for Efficient Multi-Task Learning,”* which will be publicly available on arXiv.
