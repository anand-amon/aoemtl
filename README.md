...
This implementation corresponds to the model described in the author’s paper, **“AoE-MTL: Gate-Free Expert Selection for Efficient Multi-Task Learning”** available [here](https://zenodo.org/records/17622521).
